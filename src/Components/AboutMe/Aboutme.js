    ...
    return (
        <Row id='aboutMe' className=''>
            <Modal className='modalMe' show={show} onHide={handleClose}>
                ...
                <Modal.Body>
                    <h4 className=''>Hello, I am Jeremy Lapham. I have been a wrestler for over 10 years but now I am a powerlifter and bodybuilder who now has found a career in software engineering. I have had an extentsive career in wrestling having done it almost my whole life. I have gone to masters my Freshman, Sophmore years of high school and because of COVID and health issues I wasn't able to wrestle my Junior, Senior year. But now I have become a powerlifter/bodybuilder and have done a few competitions for powerlifting and have taken home many medals. I now really want to do bodybuilding competitions for fun and to see how well I can do.</h4>
                </Modal.Body>
                <Modal.Footer>
